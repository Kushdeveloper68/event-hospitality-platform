        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <button className="hidden sm:block px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 rounded-lg transition-all">
                Login
              </button>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
              <div className="lg:col-span-6 text-left">
                <h1 className="text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] text-gray-900 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button className="px-8 py-4 bg-gray-100 text-gray-900 font-bold rounded-xl hover:bg-gray-200 transition-all text-lg flex items-center justify-center gap-2">
                    ...
                    >
                      <div className="p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="h-24 bg-white rounded-lg shadow-sm border border-gray-100"></div>
                          <div className="h-24 bg-white rounded-lg shadow-sm border border-gray-100"></div>
                          <div className="h-24 bg-white rounded-lg shadow-sm border border-gray-100"></div>
                        </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto bg-white border-2 border-dashed border-gray-300 rounded-3xl p-12 flex flex-col items-center justify-center text-center">
        ...
        <section className="py-20 bg-primary">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <button className="px-10 py-5 bg-white text-primary font-black rounded-xl text-lg shadow-xl hover:bg-gray-50 transition-all transform hover:scale-105">
