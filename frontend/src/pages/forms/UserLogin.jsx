...
function UserLogin() {
  return (
   <>
    ...
    {/* <!-- Main Login Card --> */}
    <div
      className="w-full max-w-md bg-white dark:bg-[#1c222d] rounded-lg shadow-sm border border-[#e5e7eb] dark:border-[#2d3646] p-8 md:p-10">
      {/* <!-- Logo Section --> */}
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-[#111318] dark:text-white text-2xl font-bold leading-tight tracking-tight">Welcome back</h2>
        <p className="mt-2 text-[#6b7280] dark:text-[#9ca3af] text-sm text-center">Please enter your details to sign in.</p>
      </div>
      {/* <!-- Login Form --> */}
      <form action="#" className="space-y-6">
        {/* <!-- Email Field --> */}
        <div>
          <label className="block text-sm font-medium text-[#111827] dark:text-white mb-1.5" for="email">
            Email
          </label>
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-sm font-medium text-[#111827] dark:text-white" for="password">
              Password
            </label>
        ...
        <div className="flex items-center">
          <input className="h-4 w-4 rounded border-[#d1d5db] text-primary focus:ring-primary" id="remember-me"
            name="remember-me" type="checkbox" />
          <label className="ml-2 block text-xs text-[#6b7280] dark:text-[#9ca3af]" for="remember-me">
      ...
      <div className="mt-8 border-t border-[#f3f4f6] dark:border-[#2d3646] pt-6 text-center">
        <p className="text-sm text-[#6b7280] dark:text-[#9ca3af]">
          ...
          <a className="font-semibold text-primary hover:text-primary/80 transition-colors" href="#">Create an account</a>
        </p>
      </div>
    </div>
  ...
  <div className="fixed top-0 left-0 -z-10 h-full w-full pointer-events-none overflow-hidden">
    ...
    <div
      className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full blur-3xl">
    </div>
  </div>
   </>
  )
